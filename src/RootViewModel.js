...
export class RootViewModel extends ViewModel {
  constructor(options) {
    ...
    this.preferences.on("canClear", () => { this.emitChange(); });
  }
  ...
  updateHash(hash) {
    if (hash.startsWith("#/policy/")) {
      ...
      this.loadServerPolicyViewModel =
          new LoadServerPolicyViewModel(this.childOptions({server}));
  ...
  get hasPreferences() { return this.preferences.canClear; }
}
