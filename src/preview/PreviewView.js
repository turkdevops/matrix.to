...
class LoadedPreviewView extends TemplateView {
    render(t, vm) {
        const avatar = t.mapView(
            (vm) => vm.avatarUrl,
            (avatarUrl) => {
                if (avatarUrl) {
                    return new TemplateView(avatarUrl, (t, src) =>
                        t.img({ className: "avatar", src })
                    );
                } else {
                    return new TemplateView(null, (t) =>
