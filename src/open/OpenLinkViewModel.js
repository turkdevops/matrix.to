...
export class OpenLinkViewModel extends ViewModel {
    ...
    _showServerConsent() {
        ...
        this.serverConsentViewModel = new ServerConsentViewModel(
            this.childOptions({
                servers,
                done: () => {
                    this.serverConsentViewModel = null;
    ...
    async _showLink() {
        ...
        const preferredClient = clientId
            ? this._clients.find((c) => c.id === clientId)
            : null;
        this.clientsViewModel = new ClientListViewModel(
            this.childOptions({
